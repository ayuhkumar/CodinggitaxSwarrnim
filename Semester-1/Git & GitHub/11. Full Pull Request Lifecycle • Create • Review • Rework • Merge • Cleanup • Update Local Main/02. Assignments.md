...
### Instructions
Complete all mandatory assignments in order. Use your practice repository.  
Take clear screenshots where asked. Submit the **GitHub repository link** along with the required screenshots and PR links.
...
Create a file named `day11-reflection.txt` (on main or via a small PR) and answer **in your own words**:
...
**Submit:** Content of `day11-reflection.txt` (or screenshot) + commit/PR link.
...
**Submit (optional):** PR link showing the review conversation + short note on what you learned.
