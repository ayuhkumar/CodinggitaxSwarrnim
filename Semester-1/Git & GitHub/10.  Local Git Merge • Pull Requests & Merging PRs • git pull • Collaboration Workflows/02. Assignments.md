...
### Instructions
Complete all assignments in order. Use a practice repository (create a new one or use your earlier practice repo).  
Take screenshots where asked. Submit the **GitHub repository link** and required screenshots.
