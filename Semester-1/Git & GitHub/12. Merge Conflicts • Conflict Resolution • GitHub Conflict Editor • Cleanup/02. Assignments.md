...
1. Create a file named `conflict-markers-explained.txt`.
2. In that file, write in your own words:
...
4. Commit and push this file to `main` (directly or via a small PR).

**Submit:**
- Content of `conflict-markers-explained.txt` (or screenshot)
- Commit or PR link
...
**Submit:** Content of `day12-reflection.txt` + commit/PR link.
...
| 2 | `conflict-markers-explained.txt` | Yes |
| 3 | `day12-reflection.txt` | Yes |
